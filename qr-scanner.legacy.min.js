...
a.disablePictureInPicture=!0;a.playsInline=!0;a.muted=!0;let l=!1;a.hidden&&(a.hidden=!1,l=!0);document.body.contains(a)||(document.body.appendChild(a),l=!0);d=a.parentElement;if(null===(h=b.barcodeDetectorFormats)||void 0===h?0:h.length)c._barcodeDetectorFormats=b.barcodeDetectorFormats;if(b.highlightScanRegion||b.highlightCodeOutline){h=!!b.overlay;this.$overlay=b.overlay||document.createElement("div");f=this.$overlay.style;f.position="absolute";f.display="none";f.pointerEvents="none";this.$overlay.classList.add("scan-region-highlight");
